...
#maximum likelehood to estimate
...
library(reshape2)
?extract #extract values from raster file to dataframe
...
#---------------------------------------------------#
#design II (whole area not tied to individual animal) availability: population availability
#---------------------------------------------------#
...
#--------------------------------------------------------------------------#
#design III availability (samples within the homerange of each individual): within home-range availability for each individual
#--------------------------------------------------------------------------#
