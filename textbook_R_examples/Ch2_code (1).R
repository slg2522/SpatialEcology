...
setwd("/Users/mfitzpatrick/code/spatialEcologyTextbook/data")
...
#set projection
# Note that this function does not project / transform the data - it is simply adding a label
...
#check raster values
levels(nlcd)
# this next line of code can take a while to run, FYI
...
sites <- shapefile("reptiledata/reptiledata.shp")
